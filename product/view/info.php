...
<!-- 
 ...
 -->
<div class="h_vinfo_wrap">  
    <div>
       <div class="h_vinfo_tit">
           <h4 class="list_tit">여주 블루마린캠핑장</h4>

           <div>
               <p class="basic_txt">아이들과 신나게 놀 수 있는 캠핑장!!!</p>
               <p class="basic_txt">가족캠핑하기 좋은 곳이며 넓은 주차공간과 텐트마다 공간이 충분해서 대형텐트로 단체캠핑이 가능합니다.</p>
           </div>
           <p class="basic_txt">가족과 함께 즐겁고 행복한 캠핑이 될 수 있도록 노력하겠습니다.</p>
       </div>
   </div>
   
   <div class="h_vinfo_imgbox">
       <div class="h_vinfo_campingimg" >
           <img src="//item-team-sosul.vercel.app/img/image/detail_img_4.jpg" alt="캠핑장시설사진">
       </div>
   
       <div>
           <h4 class="list_tit">소제목</h4>
   
           <section>
               <div class="h_vinfo_img">
               ...
               <div class="h_vinfo_textbox">
                   <h5 class="basic_txt">수영장</h5>
