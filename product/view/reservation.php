...
<!-- 일정/인원 선택 -->
        <div class="syre_container">
            <div class="checkinout_sy">
                <label for="checkin_sy">입실</label>
                <input type="date" id="checkin" value="2025-12-19">
                <span>~</span>
                <label for="checkout_sy">퇴실</label>
            ...
            <div class="syre_container">
                <div class="checkinout_sy">
                    <label for="number-select"> 대인 </label>
                    <select id="number-select">
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
                    </select><span class=gn_sy>명</span>
                    <label for="number-select"> 소인 </label>
                    <select id="number-select">
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
...
<!-- 객실 선택 -->
        <div class="roomsel_sy">
            <h4 class="list_tit">사이트(객실)을 선택해주세요.</h4>
