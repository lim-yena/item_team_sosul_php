<div class=rescheck_sy>
        ...
        <div class=rescheck_sy3>
            <span class=gn_sy2> 대인 </span><span class=gn_sy3>3명</span> 
            <span class=gn_sy2> 소인 </span><span class=gn_sy3>2명</span>
        </div>
        ...
        <div class=rescheck_sy5>
            <span>총액</span> 
            <span>138,000원</span>
        </div>
        <div class="rescheck_sy6">
            <button class="sebt_sy">예약하기</button>
        </div>
    </div>