<div class="borderbt_sy">
    ...
    <div class="site_sy">
        <div class="c1_sy siteC_sy">
            C1
        </div>
        <div class="c2_sy siteC_sy">
            C2
        </div>
        <div class="c3_sy siteC_sy">
            C3
        </div>
        <div class="c4_sy siteC_sy">
            C4
        </div>
        <div class="c5_sy siteC_sy">
            C5
        </div>
        <div class="c6_sy siteC_sy">
            C6
        </div>   
        <div class="c7_sy siteC_sy">
            C7
        </div>    
        <div class="c8_sy siteC_sy">
            C8
        </div>     
    </div>
</div>
    ...
    <div class="syre_container">
        <div class="checkinout_sy">
            <div class="rescheck_sy3">
                ...
                <select id="adultSelect" class="gn_sy3">
                ...
                <select id="childSelect" class="gn_sy3">
                    <option value="0">0</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
